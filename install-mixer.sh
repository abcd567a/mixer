...
echo -e "\e[1;39m$(ip route | grep -m1 -o -P 'src \K[0-9,.]*')/mixer/  OR  $(ip route | grep -m1 -o -P 'src \K[0-9,.]*'):8585 \e[39;0m"
echo ""
...
echo ""
echo ""
echo -e "\e[1;95mIMPORTANT IMPORTANT IMPORTANT - Please do following:  \e[39;0m"
